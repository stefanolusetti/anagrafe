...
?>
  ...
  f_text('titolare_nome', 'Nome e Cognome*',
    array('input' => array('class' => 'required maxlen'))
  );

  f_text('titolare_comune_nascita', 'Comune di nascita*',
    array('input' => array('class' => 'required maxlen'))
  );

  f_select('titolare_prov_nascita', 'Provincia di nascita*',
    opzioni_provincie(),
    array('input' => array('class' => 'required maxlen'))
  );
  f_text('titolare_nazione_nascita', 'Nazione di nascita (se diversa da Italia)');

  f_text('titolare_data_nascita', 'Data di nascita (nel formato gg/mm/aaaa)*',
    array('input' => array('class' => 'required data'))
  );

  f_text('titolare_comune_residenza', 'Comune di residenza*',
    array('input' => array('class' => 'required maxlen'))
  );

  f_select('titolare_prov_residenza', 'Provincia di residenza*',
    opzioni_provincie(),
    array('input' => array('class' => 'required maxlen'))
  );

  f_text('titolare_via_residenza', 'Via/Piazza*',
    array('input' => array('class' => 'required maxlen'))
  );
  ?>
  ...
  f_select(
    'tipo_rappresentanza',
  'Tipo di rappresentanza', array('Legale rappresentante' => 'Legale rappresentante',
  ...
  <?php
   ...
   <h2>Anagrafica del componente <?php echo $antimafia['antimafia_nome'];
           ?></h2>
   <div class="field">
   <?php

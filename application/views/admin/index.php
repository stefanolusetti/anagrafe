...
if ('1' == $item['is_digital']) {
  ...
  */
  printf(
    '<a class="button green" data-action="proc-request" data-item="%s">Comunicazione avvio istruttoria</a>',
    $item['ID']
  );
}
    ?>
		<label for="unlock_<?php echo $item['ID'];
    ?>"><a class="button unlock" name="<?php echo "{$item['ID']}";
    ?>" id="<?php echo "button[{$item['ID']}]";
    ?>">Attiva modifiche</a></label>
    ...
    ?>
        <td class="left">
		 <div class="stato">
            <label for="stato<?php echo $item['ID'];
    ?>"><b>Cambia stato pratica</b></label>
                <?php
    ...
    ?></label>
		 <input type="text" id="iscritti_prov_at<?php echo $item['ID'];
    ...
    if (($item['iscritti_prov_scadenza']) != null) {
        ...
        ?></label>
		 <input type="text" id="iscritti_prov_scadenza<?php echo $item['ID'];
    ...
    ?></label>
		 <input type="text" id="iscritti_at<?php echo $item['ID'];
    ...
    if (($item['iscritti_scadenza']) != null) {
        ...
        ?></label>
		 <input type="text" id="iscritti_scadenza<?php echo $item['ID'];
    ...
    ?>
		   ...
		   <!--
		     <div class="field">
	            <label for="avvio_proc_sent<?php echo $item['ID'];
    ?>"><?php query_link('avvio_proc_sent', 'Avvio del procedimento');
    ?></label>
                <?php
                   //$options = array('0' => 'no', '1' => 'si', '2' => 'non conforme');
    ...
    ?>
		    ...
		    <div class="field">
	            <label for="integrazioni<?php echo $item['ID'];
    ?>"><?php query_link('uploaded', 'Stato integrazioni');
    ?></label>
                <?php
                   $options = array('0' => 'Non richieste', '1' => 'In attesa', '2' => 'In valutazione', '3' => 'Integrazione accettata', '4' => 'Integrazione rifiutata');
    ...
    ?>
       ...
       <td class="smallbox">
	    <div class="field">
                <label for="parere_dia<?php echo $item['ID'];
    ?>"><?php query_link('parere_dia', 'Parere DIA');
    ?></label>
                <?php
    ...
    ?>
	     ...
	     <div class="field">
		  <label for="dia_scadenza<?php echo $item['ID'];
    ?>"><?php query_link('dia_scadenza', '10 gg DIA');
    ?></label>
    ...
    ?>
	   ...
	   <td class="smallbox">
	    <div class="field">
                <label for="parere_pref<?php echo $item['ID'];
    ?>"><?php query_link('parere_prefettura', 'Parere Prefettura');
    ?></label>
                <?php
    ...
    ?>
	     ...
	     <div class="field">
		  <label for="pref_scadenza_30<?php echo $item['ID'];
    ?>"><?php query_link('pref_scadenza_30', '30 gg Prefettura');
    ?></label>
    ...
    ?>
		...
		<div class="field">
                <label for="pref_soll_30_sent<?php echo $item['ID'];
    ?>"><?php query_link('pref_soll_30_sent', 'Sollecito 30 GG');
    ?></label>
                <?php
    ...
    ?>
		 ...
		 <div class="field">
		  <label for="pref_scadenza_75<?php echo $item['ID'];
    ?>"><?php query_link('pref_scadenza_75', '75 gg Prefettura');
    ?></label>
    ...
    ?>
			...
			<div class="field">
                <label for="pref_soll_75_sent<?php echo $item['ID'];
    ?>"><?php query_link('pref_soll_75_sent', 'Sollecito 75 GG');
    ?></label>
                <?php
    ...
    ?>">
                 ...
                 <input type="text" id="protocollo_struttura<?php echo $item['ID'];
    ?>" name = "protocollo_struttura[<?php echo $item['ID'];
    ?>]" value= <?php echo $item['protocollo_struttura'];
    ?>>
    ...
    ?>">
                 ...
                 <input type="text" id="fascicolo_struttura<?php echo $item['ID'];
    ?>" name = "fascicolo_struttura[<?php echo $item['ID'];
    ?>]" value= <?php echo $item['fascicolo_struttura'];
    ?>>

...
<div class="sl_wrapper">
		...
		<div class="field">
		 ...
		 <input type="text" class="iscritti_prov_at" id="iscritti_prov_at<?php echo $item['ID']; ?>" name = "iscritti_prov_at[<?php echo $item['ID']; ?>]" value= <?php echo format_date($item['iscritti_prov_at']);?>>
		 </div>
		<?php
		}
		else { ?>
		<div class="field">
		 <label for="iscritti_prov_at<?php echo $item['ID']; ?>"><?php query_link ('iscritti_prov_at',"Data di iscrizione provvisoria");?></label>
		 <input type="text" class="iscritti_prov_at" id="iscritti_prov_at<?php echo $item['ID']; ?>" name = "iscritti_prov_at[<?php echo $item['ID']; ?>]" value= <?php echo ""; ?>>
		</div>
		<?php }
		...
		<div class="field">
		 ...
		 <input type="text" class="iscritti_prov_scadenza" id="iscritti_prov_scadenza<?php echo $item['ID']; ?>" name = "iscritti_prov_scadenza[<?php echo $item['ID']; ?>]" value= <?php echo format_date($item['iscritti_prov_scadenza']);?>>
		</div>
		<?php
		}
		else { ?>
		<div class="field">
		 <label for="iscritti_prov_scadenza<?php echo $item['ID']; ?>"><?php query_link ('iscritti_prov_scadenza',"Scadenza iscrizione provvisoria");?></label>
		 <input type="text" class="iscritti_prov_scadenza" id="iscritti_prov_scadenza<?php echo $item['ID']; ?>" name = "iscritti_prov_scadenza[<?php echo $item['ID']; ?>]" value= <?php echo "";?>>
		</div>
		<?php }
		?>
		...
		<div class="field">
		 ...
		 <input type="text" class="iscritti_at" id="iscritti_at<?php echo $item['ID']; ?>" name = "iscritti_at[<?php echo $item['ID']; ?>]" value= <?php echo format_date($item['iscritti_at']);?>>
		 </div>
		<?php
		}
		else { ?>
		<div class="field">
		 <label for="iscritti_at<?php echo $item['ID']; ?>"><?php query_link ('iscritti_at',"Data di iscrizione");?></label>
		 <input type="text" class="iscritti_at" id="iscritti_at<?php echo $item['ID']; ?>" name = "iscritti_at[<?php echo $item['ID']; ?>]" value= <?php echo ""; ?>>
		</div>
		<?php }
		...
		<div class="field">
		 ...
		 <input type="text" style="background-color:red" class="iscritti_scadenza" id="iscritti_scadenza<?php echo $item['ID']; ?>" name = "iscritti_scadenza[<?php echo $item['ID']; ?>]" value= <?php echo format_date($item['iscritti_scadenza']);?>>
		</div>
		<?php }
		else {
		?>
		<div class="field">
		 <label for="iscritti_scadenza<?php echo $item['ID']; ?>"><?php query_link ('iscritti_scadenza',"Scadenza iscrizione");?></label>
		 <input type="text" class="iscritti_scadenza" id="iscritti_scadenza<?php echo $item['ID']; ?>" name = "iscritti_scadenza[<?php echo $item['ID']; ?>]" value= <?php echo format_date($item['iscritti_scadenza']);?>>
		</div>
		<?php
		}
		}

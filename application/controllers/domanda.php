...
class Domanda extends CI_Controller {
	...
	public function nuova() { #azione che mostra form vuota e salva i dati compilati
		...
		if (($this -> form_validation -> run('domanda') == FALSE) ){//&& ($this->form_validation->run('cassa_edile') == FALSE)) {
